export default {
  ...
  panic_backup_failed: 'Бэкап не был создан',
  duress_wipe_warning: 'Внимание: ввод этого кода безвозвратно удаляет реальные данные. Сначала делается попытка бэкапа, но если он не настроен, не отправился или пароль бэкапа неверный — данные всё равно удаляются. Удаление никогда не ждёт результата бэкапа.',
  panic_backup_reason_no_token: 'Токен Telegram-бота не настроен — бэкап сохранён только на диск.',
  panic_backup_reason_invalid_token: 'Токен Telegram-бота неверный или отозван — бэкап сохранён только на диск.',
  panic_backup_reason_invalid_chat_id: 'Chat ID неверный, или бот никогда не получал сообщение от этого чата — бэкап сохранён только на диск.',
  panic_backup_reason_rate_limited: 'Telegram ограничил частоту запросов — бэкап сохранён только на диск.',
  panic_backup_reason_bot_blocked: 'Бота заблокировали или удалили из чата — бэкап сохранён только на диск.',
  panic_backup_reason_telegram_rejected: 'Telegram отклонил отправку — бэкап сохранён только на диск.',
  panic_backup_reason_network_error: 'Не удалось связаться с Telegram (сетевая ошибка) — бэкап сохранён только на диск.',
  panic_backup_reason_not_configured: 'Telegram не настроен — бэкап сохранён только на диск.',
  panic_backup_reason_web_download_only: 'В веб/мобильной версии нет отправки в Telegram — бэкап скачан на устройство.',
  panic_backup_reason_no_backup_password: 'Пароль для бэкапа не задан — нечем зашифровать данные, бэкап не создан.',
  panic_backup_reason_backup_failed: 'На шаге создания бэкапа произошла непредвиденная ошибка — бэкап не создан. Проверьте логи приложения.',
  panic_backup_reason_unknown: 'Бэкап не удалось отправить — он сохранён только на диск.',
  ...
  weak_password_warning: 'Пароль слишком слабый',
  replace_with_strong: 'Заменить на сильный пароль',
  copy_password: 'Копировать пароль',
  copy_username: 'Копировать имя пользователя',
  copy_url: 'Копировать URL',
  open: 'Открыть',
  crack_time: 'Примерное время подбора',
  duplicate_password_warning: 'Пароль повторяется',
  duplicate_password_count: 'Используется в {n} других записях: {titles}',
  quick_templates: 'Быстрые шаблоны',
  export_scope: 'Что экспортировать',
  export_all: 'Все записи',
  export_selected: 'Выбранные',
  changes: 'изменений',
  presets: 'Пресеты',
  save_preset: 'Сохранить пресет',
  preset_name: 'Название пресета',
  preset_saved: 'Пресет сохранён',
  presets_exported: 'Пресеты экспортированы',
  presets_imported: 'Импортировано {n} пресетов',
  sort_by: 'Сортировка',
  sort_date: 'По дате',
  sort_name: 'По имени',
  sort_type: 'По типу',
  ...
  normal: 'Стандартный',
  large: 'Большой',
  recent_clipboard: 'Недавние копирования',
  no_copied_items: 'Пока нет скопированных элементов',
  ...
  bulk_delete_confirm: 'Удалить {n} выбранных записей?',
  bulk_deleted: 'Удалено {n} записей',
  bulk_moved: 'Перемещено {n} записей',
  health_trend: 'Динамика здоровья',
  length_label: 'Длина:',
  ...
  sync_provider_local: 'Локальная папка',
  sync_provider_server: 'Свой сервер',
  sync_server_url: 'Адрес сервера',
  sync_server_url_placeholder: 'https://your-server.example.com',
  sync_server_username: 'Имя пользователя',
  sync_server_device_name: 'Имя устройства',
  sync_server_configure: 'Подключить',
  sync_server_configured: 'Сервер подключён',
  sync_server_register: 'Создать аккаунт',
  sync_server_login: 'Войти',
  sync_server_logged_in_as: 'Вы вошли как {username}',
  sync_server_logout: 'Выйти',
  sync_server_push: 'Отправить',
  sync_server_pull: 'Получить',
  sync_server_no_account_yet: 'Ещё нет аккаунта?',
  sync_server_have_account: 'Уже есть аккаунт?',
  sync_server_configure_failed: 'Не удалось подключиться к серверу',
  sync_server_register_success: 'Аккаунт создан, теперь можно войти',
  sync_server_login_success: 'Вход выполнен успешно',
  sync_server_logout_success: 'Выход выполнен',
  sync_server_push_success: 'Вейлт отправлен на сервер',
  sync_server_pull_success_imported: 'Вейлт получен и импортирован',
  sync_server_pull_success_nochange: 'Уже актуально',
  sync_server_conflict_title: 'Конфликт синхронизации',
  sync_server_conflict_message: 'Вейлт был обновлён на устройстве «{device}» в {time}. Перезаписать его вашим локальным вейлтом или скачать актуальную версию?',
  sync_server_conflict_overwrite: 'Перезаписать',
  sync_server_conflict_download: 'Скачать актуальный',
  sync_server_conflict_cancel: 'Отмена',
